...
import getReadTime from '../../components/ReadTime';
    ...
    return (
        <>
            <div className="recent_posts">
                <h1 className='page_header lpink'>
                    <span>BLOG.</span>
                </h1>
                <div className="page_intro">
                    <p>I love to write. And I'm happy to write about various topics whether it's a technical deep dive or a soft skills piece.</p>
                </div>
